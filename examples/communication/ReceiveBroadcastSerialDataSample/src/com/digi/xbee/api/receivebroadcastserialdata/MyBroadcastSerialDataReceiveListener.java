...
/**
 * Class to manage the XBee received broadcast data that was sent by other 
 ...
 *
 */
public class MyBroadcastSerialDataReceiveListener implements ISerialDataReceiveListener {
	/*
	 * (non-Javadoc)
	...
	public void serialDataReceived(String address, byte[] data) {
		// This callback is executed when unicast serial data is received from 
	...
	public void broadcastSerialDataReceived(String address, byte[] data) {
		System.out.format("Broadcast from %s >> %s | %s%n", address, 
