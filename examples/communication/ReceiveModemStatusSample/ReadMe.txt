  ...
  -----
    ...
    * com.digi.xbee.api.receivemodemstatus.MyModemStatusReceiveListener.java:
      Class that handles the received Modem Status packets.
  ...
  by reseting the XBee device. So, press the Reset button of the carrier board 
