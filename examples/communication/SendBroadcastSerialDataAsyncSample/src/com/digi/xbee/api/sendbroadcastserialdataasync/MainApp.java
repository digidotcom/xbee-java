...
/**
 * XBee Java Library Send Broadcast Data Asynchronously sample application.
 * 
 * <p>This example sends data asynchronously to all remote devices on the same
 * network.</p>
 * 
...
public class MainApp {
	...
	public static void main(String[] args) {
		System.out.println(" +-------------------------------------------------------------+");
		System.out.println(" |  XBee Java Library Send Broadcast Data Asynchrously Sample  |");
		System.out.println(" +-------------------------------------------------------------+\n");
		...
		try {
			...
			myDevice.sendBroadcastSerialDataAsync(dataToSend);
