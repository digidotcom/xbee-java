  ...
  Bluetooth is received and stores it in a file.
  ...
  Files
  -----
    * com.digi.xbee.api.receivebluetoothfile.MainApp.java:
      Main application class. It instantiates an XBee device, establishes a
      serial connection with it and registers the listener.

    * com.digi.xbee.api.receivebluetoothfile.MyBluetoothDataReceiveListener.java:
  ...
  process:
    ...
    >> END message received, file '<path>\received_file_20190627120254.txt'
