 ...
 * Bluetooth Low Energy interface of the XBee device is received and stores it
 * in a file.</p>
 *
...
public class MainApp {
	...
	public static void main(String[] args) {
		System.out.println(" +---------------------------------------------------+");
		System.out.println(" |  XBee Java Library Receive Bluetooth File Sample  |");
		System.out.println(" +---------------------------------------------------+\n");
		...
		try {
			...
			myDevice.addBluetoothDataListener(new MyBluetoothDataReceiveListener(myDevice));
