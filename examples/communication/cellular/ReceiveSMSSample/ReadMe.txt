  Introduction
  ------------
  This sample Java application shows how SMS messages are received by a 
  ...
  Files
  -----
    * com.digi.xbee.api.receivesms.MainApp.java:
      Main application class. It instantiates a Cellular device, establishes 
      a serial connection with it and waits for incoming SMS messages.
      
    * com.digi.xbee.api.receivesms.MySMSReceiveListener:
      Class that handles the received SMS messages.
