  Introduction
  ------------
  This sample Java application shows how SMS messages are sent by a Cellular 
  device using the XBee Java Library.
  ...
  Files
  -----
    * com.digi.xbee.api.sendsms.MainApp.java:
      Main application class. It instantiates a Cellular device, establishes 
      a serial connection with it and sends an SMS message to the configured
      phone number.
  ...
  -------------
    ...
    3) Set the port and baud rate of the receiver Cellular radio in the MainApp 
       class.
    ...
    4) Set the phone number of the mobile phone to send the SMS to in the 
       'PHONE' variable of the MainApp class. Optionally, modify the text of 
