 ...
 */
package com.digi.xbee.api.sendcoapdata;
...
/**
 * XBee Java Library Send CoAP Data sample application.
 *
 * <p>This example sends CoAP data to another Thread device specified by its IPv6
...
public class MainApp {
	...
	public static void main(String[] args) {
		System.out.println(" +-------------------------------------------+");
		System.out.println(" |  XBee Java Library Send CoAP Data Sample  |");
		System.out.println(" +-------------------------------------------+\n");
		...
		try {
			...
			System.out.format("Sending CoAP data to %s >> %s | %s... ", DEST_IPV6_ADDRESS,
					HexUtils.prettyHexString(HexUtils.byteArrayToHexString(dataToSend)),
					new String(dataToSend));

			myDevice.sendCoAPData((Inet6Address) Inet6Address.getByName(DEST_IPV6_ADDRESS),
					URI, METHOD, dataToSend);
