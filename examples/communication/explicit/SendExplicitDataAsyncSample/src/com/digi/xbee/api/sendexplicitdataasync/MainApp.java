...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.format("Sending explicit data asynchronously to %s [%s - %s - %s - %s] >> %s | %s... ", remoteDevice.get64BitAddress(), 
			...
			myDevice.sendExplicitDataAsync(remoteDevice, SOURCE_ENDPOINT, DESTIANTION_ENDPOINT, CLUSTER_ID, PROFILE_ID, dataToSend);
