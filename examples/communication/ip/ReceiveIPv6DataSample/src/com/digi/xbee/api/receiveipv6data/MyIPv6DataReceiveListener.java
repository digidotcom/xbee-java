 ...
 */
package com.digi.xbee.api.receiveipv6data;
...
/**
 * Class to manage the IPv6 received data that was sent by other modules.
 *
 ...
 *
 */
public class MyIPv6DataReceiveListener implements IIPDataReceiveListener {
	/*
	 * (non-Javadoc)
	...
	public void ipDataReceived(IPMessage ipMessage) {
		System.out.format("From %s >> %s | %s%n", ipMessage.getHostAddress(),
