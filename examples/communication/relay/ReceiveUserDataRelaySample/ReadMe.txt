  ...
  from other interfaces of the XBee device using the XBee Java Library.

  The application registers a listener to be notified when new User Data Relay
  messages are received and prints their information to the standard output.
  ...
  Files
  -----
    * com.digi.xbee.api.receiveuserdatarelay.MainApp.java:
      Main application class. It instantiates an XBee device, establishes a
      serial connection with it and registers the listener.

    * com.digi.xbee.api.receiveuserdatarelay.MyUserDataRelayReceiveListener.java:
      Class that handles the received User Data Relay messages.
  ...
  interface and data is printed out in the console of the launched application:
    ...
    From Bluetooth Low Energy >> 48 65 6C 6C 6F 20 58 42 65 65 21 | Hello XBee!
