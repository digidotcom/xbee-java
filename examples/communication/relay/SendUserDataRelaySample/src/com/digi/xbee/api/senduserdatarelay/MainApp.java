 ...
 */
package com.digi.xbee.api.senduserdatarelay;
...
public class MainApp {
	...
	public static void main(String[] args) {
		System.out.println(" +-------------------------------------------------+");
		System.out.println(" |  XBee Java Library Send User Data Relay Sample  |");
		System.out.println(" +-------------------------------------------------+\n");
		...
		try {
			...
			for (int i = 0; i < 10; i++) {
				...
				System.out.format("Sending User Data Relay to %s >> '%s'... ",
						DEST_INTERFACE.getDescription(), data);

				myDevice.sendUserDataRelay(DEST_INTERFACE, data.getBytes());
