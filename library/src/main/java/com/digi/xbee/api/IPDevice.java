...
public class IPDevice extends XBeeDevice {
	 ...
	 * @see #sendBroadcastNetworkData(int, NetworkProtocol, byte[])
	...
	/**
	 * Sends the provided network data to all clients using the specified 
	 * network protocol.
	 * 
	 ...
	 * 
	 * @param destPort The destination port of the transmission.
	 * @param protocol The network protocol used for the broadcast.
	 * @param data Byte array containing the network data to be sent.
	 * 
	 * @throws IllegalArgumentException if {@code destPort < 0} or 
	 *                                  if {@code destPort > 65535}
	 ...
	 * @see com.digi.xbee.api.models.NetworkProtocol
	 */
	public void sendBroadcastNetworkData(int destPort, NetworkProtocol protocol, byte[] data) throws TimeoutException, XBeeException {
		sendNetworkData(IP32BitAddress.BROADCAST_ADDRESS, destPort, protocol, false, data);
	}
