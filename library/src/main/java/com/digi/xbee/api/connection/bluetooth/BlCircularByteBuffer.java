 ...
 */
public class BlCircularByteBuffer {
     ...
     * @since ostermillerutils 1.00.00
     */
    public BlCircularByteBuffer(int size){
        this (size, true);
    }
     ...
     * @since ostermillerutils 1.00.00
     */
    public BlCircularByteBuffer(boolean blockingWrite){
     ...
     * @since ostermillerutils 1.00.00
     */
    public BlCircularByteBuffer(int size, boolean blockingWrite){
        ...
        @Override public int read() throws IOException {
            while (true){
                synchronized (BlCircularByteBuffer.this){
                    ...
                    int available = BlCircularByteBuffer.this.available();
                    if (available > 0){
