...
public enum APIFrameType {
	...
	COAP_PASSTHRU_TX_RESPONSE (0x1D, "CoAP Passthru Tx Response"),
	COAP_PASSTHRU_TX_REQUEST (0x1E, "CoAP Passthru Tx Request"),
	TX_SMS (0x1F, "TX SMS"),
	...
	COAP_PASSTHRU_RX_REQUEST (0x9D, "CoAP Passthru Rx Request"),
	COAP_PASSTHRU_RX_RESPONSE (0x9E, "CoAP Passthru Rx Response"),
	RX_SMS (0x9F, "RX SMS"),
