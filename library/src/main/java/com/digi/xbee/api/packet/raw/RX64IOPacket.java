...
public class RX64IOPacket extends XBeeAPIPacket {
	...
	/**
	 * Returns the first IO sample contained in the packet.
	 * 
	 * @return The first IO sample of the packet, {@code null} if the packet
	 *         has not any data or if the sample could not be generated
	 *         correctly.
	 * 
