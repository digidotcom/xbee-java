...
public class SendBroadcastSerialDataTest {
	...
	public void testSendBroadcastSerialDataInvalidParams() throws Exception {
	...
	public void testSendBroadcastSerialData802InvalidOperatingMode() throws Exception {
	 ...
	 */
	@Test(expected=InvalidOperatingModeException.class)
	public void testSendBroadcastSerialDataOtherProtocolsInvalidOperatingMode() throws Exception {
		// Return that the operating mode of the device is AT when asked.
		Mockito.when(xbeeDevice.getOperatingMode()).thenReturn(OperatingMode.AT);
		// Return that the protocol of the device is ZigBee when asked.
		Mockito.when(xbeeDevice.getXBeeProtocol()).thenReturn(XBeeProtocol.ZIGBEE);
	...
	public void testSendBroadcastSerialDataFromRemoteDevices() throws Exception {
