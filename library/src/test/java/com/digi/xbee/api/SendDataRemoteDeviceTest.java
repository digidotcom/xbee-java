...
public class SendDataRemoteDeviceTest {
	...
	/**
	 * Test method for {@link com.digi.xbee.api.XBeeDevice#sendData(RemoteXBeeDevice, byte[])}.
	 * 
	 * <p>Verify that data cannot be sent if the remote XBee device is {@code null}.</p>
	 * 
	...
	public void testSendDataRemoteDeviceNull() throws TimeoutException, XBeeException {
		xbeeDevice.sendData((RemoteXBeeDevice)null, DATA.getBytes());
	}
	
	/**
	 * Test method for {@link com.digi.xbee.api.XBeeDevice#sendData(RemoteXBeeDevice, byte[])}.
	 * 
	 * <p>Verify that data can be sent if the protocol of the XBee device is ZigBee and the remote 
	...
	public void testSendDataZigBee6416() throws TimeoutException, XBeeException {
		...
		// Do nothing when the sendData(XBee64BitAddress, XBee16BitAddress, byte[]) method is called.
		Mockito.doNothing().when(xbeeDevice).sendData(Mockito.any(XBee64BitAddress.class), Mockito.any(XBee16BitAddress.class), Mockito.any(byte[].class));
		
		xbeeDevice.sendData(mockedRemoteDevice, DATA.getBytes());
		
		// Verify the sendData(XBee64BitAddress, XBee16BitAddress, byte[]) method was called.
		Mockito.verify(xbeeDevice, Mockito.times(1)).sendData(Mockito.eq(XBEE_64BIT_ADDRESS), Mockito.eq(XBEE_16BIT_ADDRESS), Mockito.eq(DATA.getBytes()));
	}
	...
	public void testSendDataZigBee64() throws TimeoutException, XBeeException {
		...
		// Verify the sendData(XBee64BitAddress, byte[]) method was called.
		Mockito.verify(xbeeDevice, Mockito.times(1)).sendData(Mockito.eq(XBEE_64BIT_ADDRESS), Mockito.eq(DATA.getBytes()));
	}
	
	/**
	 * Test method for {@link com.digi.xbee.api.XBeeDevice#sendData(RemoteXBeeDevice, byte[])}.
	 * 
	 * <p>Verify that data can be sent if the protocol of the XBee device is Point-to-Multipoint and 
	 ...
	 * Test method for {@link com.digi.xbee.api.XBeeDevice#sendData(RemoteXBeeDevice, byte[])}.
	 * 
	 * <p>Verify that data can be sent if the protocol of the XBee device is 802.15.4 and 
	...
	public void testSendDataRaw80264() throws TimeoutException, XBeeException {
		...
		raw802Device.sendData(mockedRemoteDevice, DATA.getBytes());
		
		// Verify the sendData(XBee64BitAddress, byte[]) method was called.
		Mockito.verify(raw802Device, Mockito.times(1)).sendData(Mockito.eq(XBEE_64BIT_ADDRESS), Mockito.eq(DATA.getBytes()));
	}
	...
	public void testSendDataRaw80216() throws TimeoutException, XBeeException {
		...
		// Verify the sendData(XBee16BitAddress, byte[]) method was called.
		Mockito.verify(raw802Device, Mockito.times(1)).sendData(Mockito.eq(XBEE_16BIT_ADDRESS), Mockito.eq(DATA.getBytes()));
	}
	
	/**
	 * Test method for {@link com.digi.xbee.api.XBeeDevice#sendData(RemoteXBeeDevice, byte[])}.
	 * 
	 * <p>Verify that data can be sent if the protocol of the XBee device is DigiMesh.</p>
	 * 
	 * @throws XBeeException 
	 * @throws TimeoutException 
	 */
