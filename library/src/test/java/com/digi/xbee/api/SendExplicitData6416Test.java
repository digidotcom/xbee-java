...
public class SendExplicitData6416Test {
	...
	/**
	 * Test method for {@link com.digi.xbee.api.XBeeDevice#sendExplicitData(XBee64BitAddress, XBee16BitAddress, int, int, byte[], byte[], byte[])}.
	 * 
	...
	public void testSendExplicitData64BitAddrNull() throws TimeoutException, XBeeException {
		xbeeDevice.sendExplicitData(null, XBEE_16BIT_ADDRESS, SOURCE_ENDPOINT, DESTINATION_ENDPOINT, CLUSTER_ID, PROFILE_ID, DATA.getBytes());
	}
	
	/**
	 * Test method for {@link com.digi.xbee.api.XBeeDevice#sendExplicitData(XBee64BitAddress, XBee16BitAddress, int, int, byte[], byte[], byte[])}.
	 * 
	 * <p>Verify that explicit data cannot be sent if the 16-Bit address is {@code null}.</p>
	 * 
	 * @throws XBeeException 
	 * @throws TimeoutException 
	 */
	...
	public void testSendExplicitData16BitAddrNull() throws TimeoutException, XBeeException {
		xbeeDevice.sendExplicitData(XBEE_64BIT_ADDRESS, null, SOURCE_ENDPOINT, DESTINATION_ENDPOINT, CLUSTER_ID, PROFILE_ID, DATA.getBytes());
	}
	...
	public void testSendExplicitDataSourceEndpointNegative() throws TimeoutException, XBeeException {
		xbeeDevice.sendExplicitData(XBEE_64BIT_ADDRESS, XBEE_16BIT_ADDRESS, -44, DESTINATION_ENDPOINT, CLUSTER_ID, PROFILE_ID, DATA.getBytes());
	}
	...
	public void testSendExplicitDataSourceEndpointGreater() throws TimeoutException, XBeeException {
		xbeeDevice.sendExplicitData(XBEE_64BIT_ADDRESS, XBEE_16BIT_ADDRESS, 256, DESTINATION_ENDPOINT, CLUSTER_ID, PROFILE_ID, DATA.getBytes());
	}
	...
	public void testSendExplicitDataDestinationEndpointNegative() throws TimeoutException, XBeeException {
		xbeeDevice.sendExplicitData(XBEE_64BIT_ADDRESS, XBEE_16BIT_ADDRESS, SOURCE_ENDPOINT, -59, CLUSTER_ID, PROFILE_ID, DATA.getBytes());
	}
	...
	public void testSendExplicitDataDestinationEndpointGreater() throws TimeoutException, XBeeException {
		xbeeDevice.sendExplicitData(XBEE_64BIT_ADDRESS, XBEE_16BIT_ADDRESS, SOURCE_ENDPOINT, 256, CLUSTER_ID, PROFILE_ID, DATA.getBytes());
	}
	
	/**
	 * Test method for {@link com.digi.xbee.api.XBeeDevice#sendExplicitData(XBee64BitAddress, XBee16BitAddress, int, int, byte[], byte[], byte[])}.
	 * 
	 * <p>Verify that explicit data cannot be sent if the cluster ID is {@code null}.</p>
	 * 
	 * @throws XBeeException 
	 * @throws TimeoutException 
	 */
	...
	public void testSendExplicitDataClusterIDNull() throws TimeoutException, XBeeException {
		xbeeDevice.sendExplicitData(XBEE_64BIT_ADDRESS, XBEE_16BIT_ADDRESS, SOURCE_ENDPOINT, DESTINATION_ENDPOINT, null, PROFILE_ID, DATA.getBytes());
	}
	
	/**
	 * Test method for {@link com.digi.xbee.api.XBeeDevice#sendExplicitData(XBee64BitAddress, XBee16BitAddress, int, int, byte[], byte[], byte[])}.
	 * 
	 * <p>Verify that explicit data cannot be sent if the cluster ID has an invalid length.</p>
	 * 
	 * @throws XBeeException 
	 * @throws TimeoutException 
	 */
	...
	public void testSendExplicitDataClusterIDInvalidLength() throws TimeoutException, XBeeException {
		xbeeDevice.sendExplicitData(XBEE_64BIT_ADDRESS, XBEE_16BIT_ADDRESS, SOURCE_ENDPOINT, DESTINATION_ENDPOINT, new byte[]{0x12}, PROFILE_ID, DATA.getBytes());
	}
	
	/**
	 * Test method for {@link com.digi.xbee.api.XBeeDevice#sendExplicitData(XBee64BitAddress, XBee16BitAddress, int, int, byte[], byte[], byte[])}.
	 * 
	 * <p>Verify that explicit data cannot be sent if the profile ID is {@code null}.</p>
	 * 
	 * @throws XBeeException 
	 * @throws TimeoutException 
	 */
	...
	public void testSendExplicitDataProfileIDNull() throws TimeoutException, XBeeException {
		xbeeDevice.sendExplicitData(XBEE_64BIT_ADDRESS, XBEE_16BIT_ADDRESS, SOURCE_ENDPOINT, DESTINATION_ENDPOINT, CLUSTER_ID, null, DATA.getBytes());
	}
	
	/**
	 * Test method for {@link com.digi.xbee.api.XBeeDevice#sendExplicitData(XBee64BitAddress, XBee16BitAddress, int, int, byte[], byte[], byte[])}.
	 * 
	 * <p>Verify that explicit data cannot be sent if the profile ID has an invalid length.</p>
	 * 
	 * @throws XBeeException 
	 * @throws TimeoutException 
	 */
	...
	public void testSendExplicitDataProfileIDInvalidLength() throws TimeoutException, XBeeException {
		xbeeDevice.sendExplicitData(XBEE_64BIT_ADDRESS, XBEE_16BIT_ADDRESS, SOURCE_ENDPOINT, DESTINATION_ENDPOINT, CLUSTER_ID, new byte[]{0x12}, DATA.getBytes());
	}
	...
	public void testSendExplicitDataDataNull() throws TimeoutException, XBeeException {
		xbeeDevice.sendExplicitData(XBEE_64BIT_ADDRESS, XBEE_16BIT_ADDRESS, SOURCE_ENDPOINT, DESTINATION_ENDPOINT, CLUSTER_ID, PROFILE_ID, null);
	}
	...
	public void testSendExplicitDataConnectionClosed() throws TimeoutException, XBeeException {
		...
		xbeeDevice.sendExplicitData(XBEE_64BIT_ADDRESS, XBEE_16BIT_ADDRESS, SOURCE_ENDPOINT, DESTINATION_ENDPOINT, CLUSTER_ID, PROFILE_ID, DATA.getBytes());
	}
