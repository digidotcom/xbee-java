...
public class SendExplicitData64Test {
	...
	/**
	 * Test method for {@link com.digi.xbee.api.XBeeDevice#sendExplicitData(XBee64BitAddress, int, int, byte[], byte[], byte[])}.
	 * 
	...
	public void testSendExplicitDataClusterIDNull() throws TimeoutException, XBeeException {
		xbeeDevice.sendExplicitData(XBEE_64BIT_ADDRESS, SOURCE_ENDPOINT, DESTINATION_ENDPOINT, null, PROFILE_ID, DATA.getBytes());
	}
	...
	public void testSendExplicitDataClusterIDInvalidLength() throws TimeoutException, XBeeException {
		xbeeDevice.sendExplicitData(XBEE_64BIT_ADDRESS, SOURCE_ENDPOINT, DESTINATION_ENDPOINT, new byte[]{0x12}, PROFILE_ID, DATA.getBytes());
	}
	...
	public void testSendExplicitDataProfileIDNull() throws TimeoutException, XBeeException {
		xbeeDevice.sendExplicitData(XBEE_64BIT_ADDRESS, SOURCE_ENDPOINT, DESTINATION_ENDPOINT, CLUSTER_ID, null, DATA.getBytes());
	}
	...
	public void testSendExplicitDataProfileIDInvalidLength() throws TimeoutException, XBeeException {
		xbeeDevice.sendExplicitData(XBEE_64BIT_ADDRESS, SOURCE_ENDPOINT, DESTINATION_ENDPOINT, CLUSTER_ID, new byte[]{0x12}, DATA.getBytes());
	}
