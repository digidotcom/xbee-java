...
public class SendExplicitDataAsync64Test {
	...
	/**
	 * Test method for {@link com.digi.xbee.api.XBeeDevice#sendExplicitDataAsync(XBee64BitAddress, int, int, int, int, byte[])}.
	 * 
	...
	public void testSendExplicitDataClusterIDNegative() throws TimeoutException, XBeeException {
		xbeeDevice.sendExplicitDataAsync(XBEE_64BIT_ADDRESS, SOURCE_ENDPOINT, DESTINATION_ENDPOINT, -20, PROFILE_ID, DATA.getBytes());
	}
	...
	public void testSendExplicitDataClusterIDGreater() throws TimeoutException, XBeeException {
		xbeeDevice.sendExplicitDataAsync(XBEE_64BIT_ADDRESS, SOURCE_ENDPOINT, DESTINATION_ENDPOINT, 65536, PROFILE_ID, DATA.getBytes());
	}
	...
	public void testSendExplicitDataProfileIDNegative() throws TimeoutException, XBeeException {
		xbeeDevice.sendExplicitDataAsync(XBEE_64BIT_ADDRESS, SOURCE_ENDPOINT, DESTINATION_ENDPOINT, CLUSTER_ID, -15, DATA.getBytes());
	}
	...
	public void testSendExplicitDataProfileIDGreater() throws TimeoutException, XBeeException {
		xbeeDevice.sendExplicitDataAsync(XBEE_64BIT_ADDRESS, SOURCE_ENDPOINT, DESTINATION_ENDPOINT, CLUSTER_ID, 65536, DATA.getBytes());
	}
