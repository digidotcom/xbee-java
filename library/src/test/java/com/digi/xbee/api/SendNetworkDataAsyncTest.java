...
public class SendNetworkDataAsyncTest {
	...
	/**
	 * Test method for {@link com.digi.xbee.api.IPDevice#sendNetworkDataAsync(Inet4Address, int, com.digi.xbee.api.models.NetworkProtocol, boolean, byte[])}.
	 * 
	...
	public void testSendNetworkDataAsyncIllegalPortBig() throws TimeoutException, XBeeException {
		ipDevice.sendNetworkDataAsync(ipAddress, 100000, PROTOCOL, false, DATA.getBytes());
	}
	...
	public void testSendNetworkDataAsyncIllegalPortNegative() throws TimeoutException, XBeeException {
		ipDevice.sendNetworkDataAsync(ipAddress, -10, PROTOCOL, false, DATA.getBytes());
	}
	...
	public void testSendNetworkDataAsyncProtocolNull() throws TimeoutException, XBeeException {
		ipDevice.sendNetworkDataAsync(ipAddress, PORT, null, false, DATA.getBytes());
	}
	...
	public void testSendNetworkDataAsyncDataNull() throws TimeoutException, XBeeException {
		ipDevice.sendNetworkDataAsync(ipAddress, PORT, PROTOCOL, false, null);
	}
	...
	public void testSendNetworkDataAsyncFromRemoteDevices() throws TimeoutException, XBeeException {
		...
		ipDevice.sendNetworkDataAsync(ipAddress, PORT, PROTOCOL, false, DATA.getBytes());
	}
	...
	/**
	 * Test method for {@link com.digi.xbee.api.IPDevice#sendNetworkDataAsync(Inet4Address, int, NetworkProtocol, byte[])}.
	 * 
	...
	public void testSendNetworkDataAsyncSimpleSuccess() throws TimeoutException, XBeeException {
		...
		Mockito.doNothing().when(ipDevice).sendNetworkDataAsync(Mockito.any(Inet4Address.class), Mockito.anyInt(), Mockito.any(NetworkProtocol.class), Mockito.anyBoolean(), Mockito.any(byte[].class));
		
		ipDevice.sendNetworkDataAsync(ipAddress, PORT, PROTOCOL, DATA.getBytes());
	}
}
