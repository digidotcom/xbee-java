...
public class SendNetworkDataTest {
	...
	/**
	 * Test method for {@link com.digi.xbee.api.IPDevice#sendNetworkData(IP32BitAddress, int, com.digi.xbee.api.models.NetworkProtocol, boolean, byte[])}.
	 * 
	...
	public void testSendNetworkDataIPNull() throws TimeoutException, XBeeException {
		ipDevice.sendNetworkData(null, PORT, PROTOCOL, false, DATA.getBytes());
	}
	...
	public void testSendNetworkDataIllegalPortBig() throws TimeoutException, XBeeException {
		ipDevice.sendNetworkData(IP_ADDRESS, 100000, PROTOCOL, false, DATA.getBytes());
	}
	...
	public void testSendNetworkDataIllegalPortNegative() throws TimeoutException, XBeeException {
		ipDevice.sendNetworkData(IP_ADDRESS, -10, PROTOCOL, false, DATA.getBytes());
	}
	
	/**
	 * Test method for {@link com.digi.xbee.api.IPDevice#sendNetworkData(IP32BitAddress, int, com.digi.xbee.api.models.NetworkProtocol, boolean, byte[])}.
	 * 
	 * <p>Verify that network data cannot be sent if the network protocol is {@code null}.</p>
	 * 
	 * @throws XBeeException 
	 * @throws TimeoutException 
	 */
	@Test(expected=NullPointerException.class)
	public void testSendNetworkDataProtocolNull() throws TimeoutException, XBeeException {
		ipDevice.sendNetworkData(IP_ADDRESS, PORT, null, false, DATA.getBytes());
	}
	...
	public void testSendNetworkDataDataNull() throws TimeoutException, XBeeException {
		ipDevice.sendNetworkData(IP_ADDRESS, PORT, PROTOCOL, false, null);
	}
	...
	public void testSendNetworkDataFromRemoteDevices() throws TimeoutException, XBeeException {
		...
		ipDevice.sendNetworkData(IP_ADDRESS, PORT, PROTOCOL, false, DATA.getBytes());
	}
	...
	/**
	 * Test method for {@link com.digi.xbee.api.IPDevice#sendNetworkData(IP32BitAddress, int, NetworkProtocol, byte[])}.
	 * 
	 * <p>Verify that the reduced method to send network data (who calls the expanded one) 
	 ...
	 */
	@Test
	public void testSendNetworkDataSimpleSuccess() throws TimeoutException, XBeeException {
		// Do nothing when the send network data expanded method is called.
		Mockito.doNothing().when(ipDevice).sendNetworkData(Mockito.any(IP32BitAddress.class), Mockito.anyInt(), Mockito.any(NetworkProtocol.class), Mockito.anyBoolean(), Mockito.any(byte[].class));
		
		ipDevice.sendNetworkData(IP_ADDRESS, PORT, PROTOCOL, DATA.getBytes());
	}
}
