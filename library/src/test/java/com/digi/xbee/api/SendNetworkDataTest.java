...
public class SendNetworkDataTest {
	...
	/**
	 * Test method for {@link com.digi.xbee.api.IPDevice#sendNetworkData(Inet4Address, int, com.digi.xbee.api.models.NetworkProtocol, boolean, byte[])}.
	 * 
	...
	public void testSendNetworkDataIllegalPortBig() throws TimeoutException, XBeeException {
		ipDevice.sendNetworkData(ipAddress, 100000, PROTOCOL, false, DATA.getBytes());
	}
	...
	public void testSendNetworkDataIllegalPortNegative() throws TimeoutException, XBeeException {
		ipDevice.sendNetworkData(ipAddress, -10, PROTOCOL, false, DATA.getBytes());
	}
	...
	public void testSendNetworkDataProtocolNull() throws TimeoutException, XBeeException {
		ipDevice.sendNetworkData(ipAddress, PORT, null, false, DATA.getBytes());
	}
	...
	public void testSendNetworkDataDataNull() throws TimeoutException, XBeeException {
		ipDevice.sendNetworkData(ipAddress, PORT, PROTOCOL, false, null);
	}
	...
	public void testSendNetworkDataFromRemoteDevices() throws TimeoutException, XBeeException {
		...
		ipDevice.sendNetworkData(ipAddress, PORT, PROTOCOL, false, DATA.getBytes());
	}
	...
	/**
	 * Test method for {@link com.digi.xbee.api.IPDevice#sendNetworkData(Inet4Address, int, NetworkProtocol, byte[])}.
	 * 
	...
	public void testSendNetworkDataSimpleSuccess() throws TimeoutException, XBeeException {
		...
		Mockito.doNothing().when(ipDevice).sendNetworkData(Mockito.any(Inet4Address.class), Mockito.anyInt(), Mockito.any(NetworkProtocol.class), Mockito.anyBoolean(), Mockito.any(byte[].class));
		
		ipDevice.sendNetworkData(ipAddress, PORT, PROTOCOL, DATA.getBytes());
	}
}
