...
public class SendSerialDataDigiMeshTest {
	 ...
	 */
	@Test
	public void testSendSerialDataDigiMeshInvalidParams() {
		// Try to send serial data with a null 64-bit address.
		try {
			digiMeshDevice.sendSerialData((XBee64BitAddress)null, SEND_DATA_BYTES);
		...
		try {
			digiMeshDevice.sendSerialData(XBEE_64BIT_ADDRESS, null);
			fail("Serial data shouldn't have been sent successfully.");
		} catch (Exception e) {
			assertEquals(NullPointerException.class, e.getClass());
		}
	 ...
	 */
	@Test
	public void testSendSerialDataDigiMeshConnectionClosed() throws Exception {
	 ...
	 */
	@Test
	public void testSendSerialDataDigiMeshInvalidOperatingMode() {
	 ...
	 */
	@Test
	public void testSendSerialDataDigiMeshFromRemoteDevices() {
